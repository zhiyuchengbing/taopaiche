...
if __name__ == "__main__":
    image_1 = Image.open("img/20231031061408_2.jpeg")
    image_2 = Image.open("img/20231113084227_2.jpeg")
    ...
    model.load_state_dict(torch.load("logs/VGG16-300-105,105/best_epoch_weights.pth", map_location=device))
    net = model.eval()
    net = net.cuda()
    ...
    torch.onnx.export(
        net,
        dummy_input,
        "D:\code\Vehicle_Re-identification\Siamese-pytorch-master\Siamese.onnx",
        verbose=True,
